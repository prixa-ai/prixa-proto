...
func request_AnalyticsService_TrackArticle_0(ctx context.Context, marshaler runtime.Marshaler, client AnalyticsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrackArticleRequest
	...
	msg, err := client.TrackArticle(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AnalyticsService_TrackArticle_0(ctx context.Context, marshaler runtime.Marshaler, server AnalyticsServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TrackArticleRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.TrackArticle(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAnalyticsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AnalyticsServiceServer) error {
	...
	mux.Handle("GET", pattern_AnalyticsService_TrackArticle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AnalyticsService_TrackArticle_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_AnalyticsService_TrackArticle_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAnalyticsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AnalyticsServiceClient) error {
	...
	mux.Handle("GET", pattern_AnalyticsService_TrackArticle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AnalyticsService_TrackArticle_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AnalyticsService_TrackArticle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "v1", "analytics", "article", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_AnalyticsService_TrackArticle_0 = runtime.ForwardResponseMessage
)
