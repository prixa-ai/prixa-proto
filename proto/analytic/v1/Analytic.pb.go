...
var file_proto_analytic_v1_Analytic_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x77, 0x69, 0x64, 0x74, 0x68, 0x32, 0x8a, 0x01, 0x0a, 0x0f, 0x41, 0x6e, 0x61,
...
var file_proto_analytic_v1_Analytic_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_proto_analytic_v1_Analytic_proto_goTypes = []interface{}{
	...
	nil,                         // 12: prixa.analytics.v1.EventLog.MetadataEntry
	nil,                         // 13: prixa.analytics.v1.TrackEvent.PropertiesEntry
	nil,                         // 14: prixa.analytics.v1.TrackEvent.IntegrationEntry
...
var file_proto_analytic_v1_Analytic_proto_depIdxs = []int32{
	15, // 0: prixa.analytics.v1.EventLog.date:type_name -> google.protobuf.Timestamp
	12, // 1: prixa.analytics.v1.EventLog.metadata:type_name -> prixa.analytics.v1.EventLog.MetadataEntry
	0,  // 2: prixa.analytics.v1.NalarEvent.eventLog:type_name -> prixa.analytics.v1.EventLog
	16, // 3: prixa.analytics.v1.NalarEvent.reply:type_name -> google.protobuf.Any
	16, // 4: prixa.analytics.v1.NalarEvent.result:type_name -> google.protobuf.Any
	13, // 5: prixa.analytics.v1.TrackEvent.properties:type_name -> prixa.analytics.v1.TrackEvent.PropertiesEntry
	14, // 6: prixa.analytics.v1.TrackEvent.integration:type_name -> prixa.analytics.v1.TrackEvent.IntegrationEntry
	...
	2,  // 16: prixa.analytics.v1.AnalyticService.Track:input_type -> prixa.analytics.v1.TrackEvent
	17, // 17: prixa.analytics.v1.AnalyticService.Track:output_type -> google.protobuf.Empty
