...
type ContextFields struct {
	...
	AppBuild                string `protobuf:"bytes,3,opt,name=appBuild,proto3" json:"appBuild,omitempty"`
	CampaignName            string `protobuf:"bytes,4,opt,name=campaignName,proto3" json:"campaignName,omitempty"`
	CampaignSource          string `protobuf:"bytes,5,opt,name=campaignSource,proto3" json:"campaignSource,omitempty"`
	CampaignMedium          string `protobuf:"bytes,6,opt,name=campaignMedium,proto3" json:"campaignMedium,omitempty"`
	CampaignTerm            string `protobuf:"bytes,7,opt,name=campaignTerm,proto3" json:"campaignTerm,omitempty"`
	CampaignContent         string `protobuf:"bytes,8,opt,name=campaignContent,proto3" json:"campaignContent,omitempty"`
	...
	DeviceAdvertisingId     string `protobuf:"bytes,11,opt,name=deviceAdvertisingId,proto3" json:"deviceAdvertisingId,omitempty"`
	DeviceAdTrackingEnabled string `protobuf:"bytes,12,opt,name=deviceAdTrackingEnabled,proto3" json:"deviceAdTrackingEnabled,omitempty"`
	DeviceManufacturer      string `protobuf:"bytes,13,opt,name=deviceManufacturer,proto3" json:"deviceManufacturer,omitempty"`
	...
	LocationLatitude        string `protobuf:"bytes,17,opt,name=locationLatitude,proto3" json:"locationLatitude,omitempty"`
	LocationLongitude       string `protobuf:"bytes,18,opt,name=locationLongitude,proto3" json:"locationLongitude,omitempty"`
	LocationSpeed           string `protobuf:"bytes,19,opt,name=locationSpeed,proto3" json:"locationSpeed,omitempty"`
	NetworkBluetooth        string `protobuf:"bytes,20,opt,name=networkBluetooth,proto3" json:"networkBluetooth,omitempty"`
	NetworkCarrier          string `protobuf:"bytes,21,opt,name=networkCarrier,proto3" json:"networkCarrier,omitempty"`
	NetworkCellular         string `protobuf:"bytes,22,opt,name=networkCellular,proto3" json:"networkCellular,omitempty"`
	NetworkWifi             string `protobuf:"bytes,23,opt,name=networkWifi,proto3" json:"networkWifi,omitempty"`
	OsName                  string `protobuf:"bytes,24,opt,name=osName,proto3" json:"osName,omitempty"`
	OsVersion               string `protobuf:"bytes,25,opt,name=osVersion,proto3" json:"osVersion,omitempty"`
	PagePath                string `protobuf:"bytes,26,opt,name=pagePath,proto3" json:"pagePath,omitempty"`
	PageReferrer            string `protobuf:"bytes,27,opt,name=pageReferrer,proto3" json:"pageReferrer,omitempty"`
	PageSearch              string `protobuf:"bytes,28,opt,name=pageSearch,proto3" json:"pageSearch,omitempty"`
	PageTitle               string `protobuf:"bytes,29,opt,name=pageTitle,proto3" json:"pageTitle,omitempty"`
	PageUrl                 string `protobuf:"bytes,30,opt,name=pageUrl,proto3" json:"pageUrl,omitempty"`
	ScreenDensity           string `protobuf:"bytes,31,opt,name=screenDensity,proto3" json:"screenDensity,omitempty"`
	ScreenHeight            string `protobuf:"bytes,32,opt,name=screenHeight,proto3" json:"screenHeight,omitempty"`
	ScreenWidth             string `protobuf:"bytes,33,opt,name=screenWidth,proto3" json:"screenWidth,omitempty"`
}
...
func (x *ContextFields) GetAppName() string {
	if x != nil {
		return x.AppName
	}
	return ""
...
func (x *ContextFields) GetAppVersion() string {
	if x != nil {
		return x.AppVersion
	}
	return ""
...
func (x *ContextFields) GetAppBuild() string {
	if x != nil {
		return x.AppBuild
	}
	return ""
...
func (x *ContextFields) GetCampaignName() string {
	if x != nil {
...
func (x *ContextFields) GetCampaignSource() string {
	if x != nil {
		return x.CampaignSource
	}
	return ""
}

func (x *ContextFields) GetCampaignMedium() string {
	if x != nil {
		return x.CampaignMedium
	}
	return ""
}

func (x *ContextFields) GetCampaignTerm() string {
	if x != nil {
		return x.CampaignTerm
	}
	return ""
}

func (x *ContextFields) GetCampaignContent() string {
	if x != nil {
...
func (x *ContextFields) GetDeviceType() string {
	if x != nil {
		return x.DeviceType
	}
	return ""
...
func (x *ContextFields) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *ContextFields) GetDeviceAdvertisingId() string {
	if x != nil {
		return x.DeviceAdvertisingId
	}
	return ""
}

func (x *ContextFields) GetDeviceAdTrackingEnabled() string {
	if x != nil {
		return x.DeviceAdTrackingEnabled
	}
	return ""
}

func (x *ContextFields) GetDeviceManufacturer() string {
	if x != nil {
...
func (x *ContextFields) GetDeviceModel() string {
	if x != nil {
...
func (x *ContextFields) GetDeviceName() string {
	if x != nil {
		return x.DeviceName
	}
	return ""
...
func (x *ContextFields) GetLocationLatitude() string {
	if x != nil {
...
func (x *ContextFields) GetLocationLongitude() string {
	if x != nil {
...
func (x *ContextFields) GetLocationSpeed() string {
	if x != nil {
		return x.LocationSpeed
	}
	return ""
}

func (x *ContextFields) GetNetworkBluetooth() string {
	if x != nil {
		return x.NetworkBluetooth
	}
	return ""
}

func (x *ContextFields) GetNetworkCarrier() string {
	if x != nil {
...
func (x *ContextFields) GetNetworkCellular() string {
	if x != nil {
		return x.NetworkCellular
	}
	return ""
}

func (x *ContextFields) GetNetworkWifi() string {
	if x != nil {
		return x.NetworkWifi
	}
	return ""
}

func (x *ContextFields) GetOsName() string {
	if x != nil {
		return x.OsName
	}
	return ""
...
func (x *ContextFields) GetOsVersion() string {
	if x != nil {
		return x.OsVersion
	}
	return ""
...
func (x *ContextFields) GetPagePath() string {
	if x != nil {
		return x.PagePath
	}
	return ""
...
func (x *ContextFields) GetPageReferrer() string {
	if x != nil {
		return x.PageReferrer
	}
	return ""
}

func (x *ContextFields) GetPageSearch() string {
	if x != nil {
		return x.PageSearch
	}
	return ""
...
func (x *ContextFields) GetPageTitle() string {
	if x != nil {
		return x.PageTitle
	}
	return ""
...
func (x *ContextFields) GetPageUrl() string {
	if x != nil {
		return x.PageUrl
	}
	return ""
...
func (x *ContextFields) GetScreenDensity() string {
	if x != nil {
...
func (x *ContextFields) GetScreenHeight() string {
	if x != nil {
...
func (x *ContextFields) GetScreenWidth() string {
	if x != nil {
...
var file_proto_analytic_v1_Analytic_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x22, 0xb3, 0x09, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x46, 0x69,
	0x65, 0x6c, 0x64, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x2f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x3a, 0x01, 0x2a, 0x42,
	0xd3, 0x02, 0x92, 0x41, 0xcf, 0x02, 0x12, 0xba, 0x01, 0x0a, 0x1a, 0x50, 0x72, 0x69, 0x78, 0x61,
	0x20, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x74, 0x69, 0x63, 0x20, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_proto_analytic_v1_Analytic_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_analytic_v1_Analytic_proto_goTypes = []interface{}{
	...
	nil,                         // 4: prixa.analytics.v1.EventLog.MetadataEntry
	nil,                         // 5: prixa.analytics.v1.TrackEvent.PropertiesEntry
	nil,                         // 6: prixa.analytics.v1.TrackEvent.IntegrationEntry
	(*timestamp.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*any.Any)(nil),             // 8: google.protobuf.Any
	(*empty.Empty)(nil),         // 9: google.protobuf.Empty
}
var file_proto_analytic_v1_Analytic_proto_depIdxs = []int32{
	7, // 0: prixa.analytics.v1.EventLog.date:type_name -> google.protobuf.Timestamp
	4, // 1: prixa.analytics.v1.EventLog.metadata:type_name -> prixa.analytics.v1.EventLog.MetadataEntry
	0, // 2: prixa.analytics.v1.NalarEvent.eventLog:type_name -> prixa.analytics.v1.EventLog
	8, // 3: prixa.analytics.v1.NalarEvent.reply:type_name -> google.protobuf.Any
	8, // 4: prixa.analytics.v1.NalarEvent.result:type_name -> google.protobuf.Any
	5, // 5: prixa.analytics.v1.TrackEvent.properties:type_name -> prixa.analytics.v1.TrackEvent.PropertiesEntry
	6, // 6: prixa.analytics.v1.TrackEvent.integration:type_name -> prixa.analytics.v1.TrackEvent.IntegrationEntry
	3, // 7: prixa.analytics.v1.TrackEvent.context:type_name -> prixa.analytics.v1.ContextFields
	2, // 8: prixa.analytics.v1.AnalyticService.Track:input_type -> prixa.analytics.v1.TrackEvent
	9, // 9: prixa.analytics.v1.AnalyticService.Track:output_type -> google.protobuf.Empty
