...
var file_proto_analytic_v1_Analytic_proto_rawDesc = []byte{
	...
	,
...
var file_proto_analytic_v1_Analytic_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_analytic_v1_Analytic_proto_goTypes = []interface{}{
	...
	nil,                         // 2: prixa.analytics.v1.EventLog.MetadataEntry
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*any.Any)(nil),             // 4: google.protobuf.Any
	(*empty.Empty)(nil),         // 5: google.protobuf.Empty
}
var file_proto_analytic_v1_Analytic_proto_depIdxs = []int32{
	3, // 0: prixa.analytics.v1.EventLog.date:type_name -> google.protobuf.Timestamp
	2, // 1: prixa.analytics.v1.EventLog.metadata:type_name -> prixa.analytics.v1.EventLog.MetadataEntry
	0, // 2: prixa.analytics.v1.NalarEvent.eventLog:type_name -> prixa.analytics.v1.EventLog
	4, // 3: prixa.analytics.v1.NalarEvent.reply:type_name -> google.protobuf.Any
	4, // 4: prixa.analytics.v1.NalarEvent.result:type_name -> google.protobuf.Any
	0, // 5: prixa.analytics.v1.AnalyticService.Track:input_type -> prixa.analytics.v1.EventLog
	5, // 6: prixa.analytics.v1.AnalyticService.Track:output_type -> google.protobuf.Empty
...
type AnalyticServiceClient interface {
	Track(ctx context.Context, in *EventLog, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *analyticServiceClient) Track(ctx context.Context, in *EventLog, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AnalyticServiceServer interface {
	Track(context.Context, *EventLog) (*empty.Empty, error)
}
...
func (*UnimplementedAnalyticServiceServer) Track(context.Context, *EventLog) (*empty.Empty, error) {
...
func _AnalyticService_Track_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticServiceServer).Track(ctx, req.(*EventLog))
	}
