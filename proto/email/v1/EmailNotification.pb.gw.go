...
/*
Package prixa_emailnotification_v1 is a reverse proxy.
...
func request_NotificationService_EmailDiagnosticResult_0(ctx context.Context, marshaler runtime.Marshaler, client NotificationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EmailDiagnosticResultRequest
	...
	msg, err := client.EmailDiagnosticResult(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_NotificationService_EmailDiagnosticResult_0(ctx context.Context, marshaler runtime.Marshaler, server NotificationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EmailDiagnosticResultRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.EmailDiagnosticResult(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_NotificationService_EmailDiagnosticResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NotificationService_EmailDiagnosticResult_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_NotificationService_EmailDiagnosticResult_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_NotificationService_EmailDiagnosticResult_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_NotificationService_EmailDiagnosticResult_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_NotificationService_EmailDiagnosticResult_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "prixa", "email", "send"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_NotificationService_EmailDiagnosticResult_0 = runtime.ForwardResponseMessage
)
