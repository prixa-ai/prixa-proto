...
var (
	filter_TelemedicineService_GetDoctorTimeSlotsData_0 = &utilities.DoubleArray{Encoding: map[string]int{"hospitalId": 0, "doctorId": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_TelemedicineService_GetDoctorTimeSlotsData_0(ctx context.Context, marshaler runtime.Marshaler, client TelemedicineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TelemedicineService_GetDoctorTimeSlotsData_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_TelemedicineService_GetDoctorTimeSlotsData_0(ctx context.Context, marshaler runtime.Marshaler, server TelemedicineServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_TelemedicineService_GetDoctorTimeSlotsData_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	...
	pattern_TelemedicineService_GetDoctorTimeSlotsData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6, 1, 0, 4, 1, 5, 7}, []string{"api", "v1", "telemedicine", "timeslot", "hospital", "hospitalId", "doctor", "doctorId"}, "", runtime.AssumeColonVerbOpt(true)))
