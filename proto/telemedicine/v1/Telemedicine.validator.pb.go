...
var _regex_DoctorScheduleData_ScheduleId = regexp.MustCompile(`^([a-fA-F0-9]{8}-[a-fA-F0-9]{4}-[4][a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12})?$`)

func (this *DoctorScheduleData) Validate() error {
	if !_regex_DoctorScheduleData_ScheduleId.MatchString(this.ScheduleId) {
