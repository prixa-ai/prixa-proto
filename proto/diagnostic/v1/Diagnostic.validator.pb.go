...
func (this *GetDiagnosisResultResponse) Validate() error {
	...
	if this.Symptom != nil {
		if err := github_com_mwitkow_go_proto_validators.CallValidatorIfExists(this.Symptom); err != nil {
			return github_com_mwitkow_go_proto_validators.FieldError("Symptom", err)
		}
	}
